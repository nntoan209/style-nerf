...
def config_parser(cmd=None):
    ...
    parser.add_argument("--wikiartdir", type=str, default='../data/artbench-10-imagefolder',
                        help='input data directory')
    parser.add_argument("--progress_refresh_rate", type=int, default=10,
                        help='how many iterations to show psnrs or iters')

    parser.add_argument('--with_depth', action='store_true')
    parser.add_argument('--downsample_train', type=float, default=800/256)
    parser.add_argument('--downsample_test', type=float, default=800/256)
